        ...
        <div class="dropdown clearfix">
            <ul class="dropdown-menu well" style="display:inline;position:relative;width:100%;z-index:10;">
                ...
                <li >
                    ...
                    <g:link action="edit" id="${addressBookInstance?.id}">
                        <i class="fa fa-pencil"></i>
                        <g:message code="default.button.edit.label" default="Create" />
                    </g:link>
                    <g:link action="delete" id="${addressBookInstance?.id}">
        ...
        <div class="panel panel-default">
            ...
            <div id="editContent" class="panel-collapse collapse in">
				...
				<dl class="dl-horizontal">
					...
					<g:if test="${addressBookInstance?.benutzer}">
						<dt><g:message code="addressBook.benutzer.label" default="Benutzer" /></dt>
						
							<dd><g:link controller="benutzer" action="show" id="${addressBookInstance?.benutzer?.id}">${addressBookInstance?.benutzer?.encodeAsHTML()}</g:link></dd>
						
					</g:if>
				
					<g:if test="${addressBookInstance?.name}">
						<dt><g:message code="addressBook.name.label" default="Name" /></dt>
						
							<dd><g:fieldValue bean="${addressBookInstance}" field="name"/></dd>
