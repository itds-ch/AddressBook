        ...
        <div class="dropdown clearfix">
            <ul class="dropdown-menu well" style="display:inline;position:relative;width:100%;z-index:10;">
                ...
                <li >
                    ...
                    <g:link action="show" id="${benutzerInstance?.id}">
        ...
        <div class="panel panel-default">
            ...
            <div id="editContent" class="panel-collapse collapse in">
                <div class="panel-body">
                    ...
                    <g:form class="form-horizontal" role="form" action="delete" method="DELETE" id="${benutzerInstance?.id}">
                        <g:hiddenField name="version" value="${benutzerInstance?.version}" />


                        <div class="alert alert-danger" role="alert"><g:message code="default.delete.question" args="[benutzerInstance]" /></div>


                        <div class="form-group">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-danger"><g:message code="default.button.delete.label" /></button>
                                <g:link action="show" id="${benutzerInstance?.id}" class="btn btn-default"><g:message code="default.button.cancel.label" /></g:link>
                            </div>
                        </div>
