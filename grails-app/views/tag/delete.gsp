        ...
        <div class="panel panel-default">
            ...
            <div id="editContent" class="panel-collapse collapse in">
                <div class="panel-body">
                    ...
                    <g:form class="form-horizontal" role="form" action="delete" method="DELETE" id="${tagInstance?.id}">
                        <g:hiddenField name="version" value="${tagInstance?.version}" />


                        <div class="alert alert-danger" role="alert"><g:message code="default.delete.question" args="[tagInstance]" /></div>


                        <div class="form-group">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-danger"><g:message code="default.button.delete.label" /></button>
                                <g:link action="show" id="${tagInstance?.id}" class="btn btn-default"><g:message code="default.button.cancel.label" /></g:link>
                            </div>
                        </div>
